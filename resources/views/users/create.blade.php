        ...
        <form method="POST" action="{{ route('user.store') }}" enctype=multipart/form-data>
            ...
            <div class="mb-3 flex gap-3">
                <div class="w-32">
                    ...
                    <div class="relative flex gap-3">
                        <input name="prefixname" type="text" id="prefixname" value="{{ old('prefixname') }}"
                ...
                <div class="w-full">
                    ...
                    <div class="relative flex gap-3">
                        <input name="firstname" type="text" id="firstname" required value="{{ old('firstname') }}"
                ...
                <div class="w-full">
                    ...
                    <div class="relative flex gap-3">
                        <input name="middlename" type="text" id="middlename" value="{{ old('middlename') }}"
                            class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                    </div>
                    @error('middlename')
                    <span class="text-red-600 text-xs" role="alert">
                ...
                <div class="w-full">
                    ...
                    <div class="relative flex gap-3">
                        <input name="lastname" type="text" id="lastname" required value="{{ old('lastname') }}"
                            class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                    </div>
                    @error('lastname')
                    <span class="text-red-600 text-xs" role="alert">
                ...
                <div class="w-24">
                    ...
                    <div class="relative flex gap-3">
                        <input name="suffixname" type="text" id="suffixname" value="{{ old('suffixname') }}"
            ...
            <div class="mb-3 flex gap-3">
                <div class="w-full">
                    ...
                    <div class="relative flex gap-3">
                        <input name="username" type="text" id="username" required value="{{ old('username') }}"
